...
async def mylescars(phone, client, out):
    name = "mylescars"
    domain = "mylescars.com"
    ...
    try:
        ...
        if "success@::::" in str(response_data).lower() or response_data.get("success") == True or response_data.get("msg") == "success":
            out.append({
                "name": name,
                "domain": domain,
